				...
				actions : {
					...
					iRememberAnIdOfAnObjectThatsNotInTheList : function () {
						return this.waitFor(this.createAWaitForAnEntitySet({
							entitySet : "SEPMRA_C_PO_Employee",
					...
					iRememberTheListItem : function (oListItem) {
						...
						this.getContext().currentItem = {
							...
							title: oBindingContext.getProperty("Employee")
						};
					}
				},
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "SEPMRA_C_PO_Employee (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'SEPMRA_C_PO_Employee (0)'");
							},
					...
					theListShouldBeSortedAscendingOnName : function () {
						return this.theListShouldBeSortedAscendingOnField("Employee");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all SEPMRA_C_PO_Employee to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "SEPMRA_C_PO_Employee (" + iExpectedLength + ")"}),
									success : function () {
