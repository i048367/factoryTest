sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Employee").length, 1, "The sorting by Employee returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Employee and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Employee");
